...
export const AdminPanel = ({ rooms }: AdminPanelProps) => {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 sm:gap-4 mb-6">
      ...
      <Card className="p-3 sm:p-4 text-center">
        <div className="text-xl sm:text-2xl font-bold text-blue-600">{stats.occupied}</div>
        <div className="text-xs sm:text-sm text-gray-600">Occupied</div>
      </Card>
      
      <Card className="p-3 sm:p-4 text-center">
        <div className="text-xl sm:text-2xl font-bold text-red-600">{stats.checkout}</div>
        <div className="text-xs sm:text-sm text-gray-600">Checkout</div>
      </Card>
      
      <Card className="p-3 sm:p-4 text-center">
        <div className="text-xl sm:text-2xl font-bold text-orange-600">{stats.dirty}</div>
        <div className="text-xs sm:text-sm text-gray-600">Dirty</div>
      </Card>
      
      <Card className="p-3 sm:p-4 text-center">
        <div className="text-xl sm:text-2xl font-bold text-green-600">{stats.clean}</div>
        <div className="text-xs sm:text-sm text-gray-600">Clean</div>
      </Card>
